 ...
 * 发送到chinabank支付网关的调用返回地址v_url设置为：http://www.domain.com/xx/xx/boc/b2c/server。xx/xx/为NotifyServlet的path
 * @author Administrator
 *
 */
public class BocB2cServerPayResultService implements PayResultService {
